...
const {populateTodos, todos, populateUsers, users} = require('./seeds/seeds')
...
describe('POST /users', () => {
    ...
    it ('should return validation error if request invalid', (done) => {
        request(app)
            .post('/users')
            .send({email: "blablabla", password: "abc123"})
            .expect(400)
            .end(done)

    })

    it('should not create new user if email is taken', (done) => {
        request(app)
            .post('/users')
